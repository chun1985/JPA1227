	...
	public String addStudent(Student s) {
		...
		try {
			...
			conn = DriverManager.getConnection(
					"jdbc:mysql://localhost:3306/javadb?serverTimezone=CST&useUnicode=true&characterEncoding=utf8",
					"root", "root");
			String sql = "INSERT INTO javadb.student1227(sid,name,age)VALUES(?,?,?);";
